...
namespace NClassifier.Bayesian
{
	...
	{
		/// <summary>
		/// Gets the word probability of the given word.
		/// </summary>
		/// <param name="word">The word to calculate the probability of.</param>
		/// <returns>The word probability if the word exists.</returns>
		WordProbability GetWordProbability(string word);

		/// <summary>
		/// Adds a matching word to the data source.
		/// </summary>
		/// <param name="word">The word that matches.</param>
		void AddMatch(string word);

		/// <summary>
		/// Add a non-matching word to the data source.
		/// </summary>
		/// <param name="word">The word that does not match.</param>
		void AddNonMatch(string word);
	}
}
