...
{
	public class WordsDataSourceException : Exception
	{
		public WordsDataSourceException() {}

		public WordsDataSourceException(string message) : base(message) {}

		public WordsDataSourceException(string message, Exception ex) : base(message, ex) {}
	}
}